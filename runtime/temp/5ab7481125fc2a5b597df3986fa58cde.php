<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"E:\phpStudy\WWW\tp5\public/../application/tpl\message.html";i:1526521956;}*/ ?>
<!--
<!DOCTYPE html>
<html lang="en">
<head>
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/static/tanchuang/styles/style.css">
    <style>
        <?php
            if($code == 1){
    ...
    <div class="modal__dialog">
        <div class="modal__content" deep="2">
            ...
            <div style="display: block; min-height: 150px;">
                <img style="width: 150px; float:left; height: auto" src="/static/tanchuang/<?php if($code == 1){ echo 'success.png';}else{ echo 'error.png';}?>" class="face" alt="">
