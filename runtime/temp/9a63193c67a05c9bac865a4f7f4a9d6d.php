<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\phpStudy\WWW\tp5\public/../application/admin\view\index\index.html";i:1525848716;s:69:"E:\phpStudy\WWW\tp5\public/../application/admin\view\public\base.html";i:1526448948;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="<?php echo url("","",true,false);?>">
            <img class="my-header-logo" src="__STATIC__/images/logo.png" alt="logo">
        </a>
...
<script type="text/javascript" src="__STATIC__/js/functions.js"></script>
