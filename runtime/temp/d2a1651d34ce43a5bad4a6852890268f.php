<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\phpStudy\WWW\tp5\public/../application/admin\view\article\edit.html";i:1509023550;s:69:"E:\phpStudy\WWW\tp5\public/../application/admin\view\public\head.html";i:1526439758;s:71:"E:\phpStudy\WWW\tp5\public/../application/admin\view\public\footer.html";i:1525850960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('Article/edit'); ?>" method="post" class="layui-form">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item" style="width: 700px;">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" value="<?php echo $res['name']; ?>" required  lay-verify="required" placeholder="请输入分类名" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="oid" value="<?php echo $res['oid']; ?>" placeholder="越小越靠前" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item layui-form-text" style="width: 700px;">
                    ...
                    <div class="layui-input-block">
                        <textarea name="info"  placeholder="请不要超过250字的简介" class="layui-textarea"><?php echo $res['info']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text" >
                    ...
                    <div class="layui-input-block">
                        <textarea id="article_content" name="content" placeholder="" class="layui-textarea"><?php echo $res['content']; ?></textarea>
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">其他选项
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="status" value="0" title="否" <?php if($res['status'] == 0): ?> checked <?php else: endif; ?>>
                        <input type="radio" name="status" value="1" title="是" <?php if($res['status'] == 1): ?> checked <?php else: endif; ?>>
                    </div>
                </div>
