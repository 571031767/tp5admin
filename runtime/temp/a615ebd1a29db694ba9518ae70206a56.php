<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\tp5\public/../application/admin\view\my_auth_user_group\add.html";i:1525686455;s:69:"E:\phpStudy\WWW\tp5\public/../application/admin\view\public\head.html";i:1526439758;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(''); ?>" method="post" class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="title" required value="" placeholder="请输入" autocomplete="off" class="layui-input">
        </div>
